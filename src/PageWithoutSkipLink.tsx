  ...
  return (
    <>
      ...
      <header className="sticky-header bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-900">
            Skip Link Demo Application (No Skip Link)
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 grid grid-cols-1 md:grid-cols-4 gap-6 min-h-[100vh]">
        ...
        <main
          id="main-content"
          className="col-span-1 md:col-span-3 bg-white p-8 rounded-xl shadow-lg"
        >
          <h2 className="text-3xl font-extrabold text-gray-900 mb-4">
            Main Content Area
          </h2>
          <p className="text-lg text-emerald-600 mb-6 border-b pb-4">
            This is the Main Content Area. Without a Skip Link, keyboard users
            must tab through all navigation items (header links and sidebar
            links) before reaching this point.
          </p>
...
export default PageWithoutSkipLink;
